...
/* 
Code function classNames ini buat gabungin classname yang ada terus ditambahi.. nanti contohnya di bawah ini buat ganti ganti tampilan
*/
function classNames(...classes) {
  return classes.filter(Boolean).join(' ')
}

//Ini function utama navbar yang nanti bakal dipanggil di App.js
